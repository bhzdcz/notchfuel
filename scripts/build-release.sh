...
APP_NAME="TopNotch AI"
APP_BUNDLE="$BUILD_DIR/$APP_NAME.app"
DMG_PATH="$RELEASE_DIR/TopNotchAI-1.2.0-arm64.dmg"
...
cp ".build/arm64-apple-macosx/release/TopNotchAI" "$APP_BUNDLE/Contents/MacOS/TopNotchAI"
